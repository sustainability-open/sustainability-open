...
// This file implements a steel HE400A beam
...
namespace ComponentWithVisualOutputExample
{
    ...
    /// </summary>
    public class Beam_HE400A : Beam_HE
    {
        /// <summary>
        /// Constructor
        ...
        /// </summary>
        public Beam_HE400A(SOPoint3d beginpoint, SOPoint3d endpoint)
            : base("HE400A", 1.5, "m3", beginpoint, endpoint)
        {
        }
