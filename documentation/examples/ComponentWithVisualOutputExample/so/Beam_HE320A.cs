...
// This file implements a steel HE320A beam
...
namespace ComponentWithVisualOutputExample
{
    ...
    /// </summary>
    public class Beam_HE320A : Beam_HE
    {
        /// <summary>
        /// Constructor
        ...
        /// </summary>
        public Beam_HE320A(SOPoint3d beginpoint, SOPoint3d endpoint)
            : base("HE320A", 1.0, "m3", beginpoint, endpoint)
        {
        }
